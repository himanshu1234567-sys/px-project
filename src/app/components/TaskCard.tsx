...
const TaskCard: React.FC<TaskCardProps> = ({
  ...
  const taskNameRef = useRef<HTMLDivElement | any>(null);
  ...
  const handleDescriptionRemoveClick = (e: any, index: number) => {
    e.stopPropagation();
  ...
  }, [task.id, editableName, onUpdateTaskName]);
  ...
  }, [isEditingName, handleOutsideClick]);
